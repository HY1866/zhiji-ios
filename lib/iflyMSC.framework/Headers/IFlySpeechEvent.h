...
typedef NS_ENUM(NSUInteger,IFlySpeechEventType){
    ...
    /*!
     *  服务端评测音频url<br>
     *  在消息到达时,第4个参数data,包含数据,通过指定KEY为 -- 获取.
     */
    IFlySpeechEventTypeDownloadkey = 20002,
    /*!
     *  服务端评测结果url<br>
     *  在消息到达时,第4个参数data,包含数据,通过指定KEY为 -- 获取.
     */
    IFlySpeechEventTypeResultkey = 20003,
 ...
 *  服务端评测音频url key
 */
extern NSString* const KCIFlySpeechEventKeyDownloadkey;
/**
 *  服务端评测结果url key
 */
extern NSString* const KCIFlySpeechEventKeyresultkey;
